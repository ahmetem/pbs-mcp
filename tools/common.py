...
Includes:
  * `fmt_bytes` / `fmt_unix_ts` — human-readable formatters
  * `confirm_required` — raises if confirm flag missing on a write tool
  * Markdown table helpers — keep tool output consistent with proxmox-mcp
"""
